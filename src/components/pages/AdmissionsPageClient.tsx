...
/* ──────────────────────────────────────────────
   Section 6 — Student Enquiry Form
   ────────────────────────────────────────────── */
...
function EnquiryFormSection() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    // Set the relation value based on selection
  ...
  if (status === "success") {
    return (
      <section className="relative bg-gradient-to-b from-[var(--navy)] to-[#1a2d4d] py-24 px-6 overflow-hidden">
        <FloatingShape color="#4ECDC4" size={80} top="15%" left="8%" shape="circle" delay={0} />
        <FloatingShape color="#F5A623" size={55} top="70%" left="85%" shape="star" delay={1} />
  ...
  return (
    <section id="enquiry-form" className="relative bg-gradient-to-b from-[var(--navy)] to-[#1a2d4d] py-24 px-6 overflow-hidden">
      <FloatingShape color="#F5A623" size={90} top="5%" left="3%" shape="circle" delay={0} />
      <FloatingShape color="#4ECDC4" size={60} top="80%" left="90%" shape="triangle" delay={1} />
      <FloatingShape color="#A78BFA" size={45} top="20%" left="92%" shape="star" delay={0.5} />
      <FloatingShape color="#FF6B6B" size={55} top="65%" left="6%" shape="square" delay={1.5} />
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          <h2 className="text-title font-display text-white mt-2">
